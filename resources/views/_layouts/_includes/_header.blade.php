                            ...
                            <ul class="nav11__list">
                                <li class="navbar11">
                                    ...
                                    <label for="group-2"><span
                                            class="fa fa-caret-right"></span>@lang('redimensionamento.menuRedimensionamento')</label>
                                    <ul class="group-list">
                            ...
                            <ul class="menu3">
                                @if (session()->has('idiomas'))
                                    @foreach (Session::get('idiomas') as $idioma)
                                        <li><a href="{{ route('alterarIdioma', $idioma['valor']) }}"> <img
                                                    class="bandeiras"
                                                    src="{{ asset('img/flags/' . $idioma['valor'] . '.png') }}"
                                                    alt=""> @lang('idioma.' . $idioma['valor'])</a></li>
                                    @endforeach
                                @endif
                            </ul>
                        </li>
