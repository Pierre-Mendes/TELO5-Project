        ...
        <nav class="nav11" role="navigation">
            <ul class="nav11__list">
                <li class="navbar11">
                    ...
                    <a href="{{ route('manage_technical_delivery') }}" class="nav-link entrega-tecnica-link">@lang('entregaTecnica.entregaTecnica')<span class="fa fa-caret-right"></span></a>
        ...
        <li id="user" class="user-mobile-425">
            ...
            <ul class="menu2">
                ...
                @can('admin')
                    ...
                    <li class="container">
                        <i class='fa fa-fw fa-shower'></i> <a href="{{ route('manage_nozzles') }}">@lang('sidenav.bocais')</a>
                    </li>
                    <li class="container">
