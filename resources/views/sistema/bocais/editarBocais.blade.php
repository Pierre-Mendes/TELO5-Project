...
<div>
    ...
    <form action="{{ route('bocais.edita') }}" method="post" class="mt-3" id="formdados">
                ...
                <div class="col-md-12 position">
                    ...
                    <div class="form-row justify-content-start">
                        <div class="form-group col-md-3 telo5ce">
                            ...
                            <input type="text" class="form-control telo5ce" id="fabricante" name="fabricante" maxlength="100"  autocomplete="off" required value="{{ $bocal->fabricante }}">
                        </div>

                        <div class="form-group col-md-3 telo5ce">
                            <label for="modelo"><span><b>@lang('bocais.modelo')</b></span></label>
                            <input type="text" class="form-control telo5ce" id="modelo" name="modelo" maxlength="100"  autocomplete="off" required value="{{ $bocal->modelo }}">
                        </div>

                        <div class="form-group col-md-3 telo5ce">
                            <label for="nome"><span><b>@lang('bocais.nome')</b></span></label>
                            <input type="number" class="form-control telo5ce" min="0.1" step="0.1" id="nome" name="nome" maxlength="100" required value="{{ $bocal->nome }}">
                        </div>

                        <div class="form-group col-md-3 telo5ce">
                            <label for="vazao_10_psi"><span><b>@lang('bocais.vazao_10_psi')</b></span></label>
                            <input type="number" class="form-control telo5ce" min="0.0001" step="0.0001" id="vazao_10_psi" name="vazao_10_psi" maxlength="100" required value="{{ $bocal->vazao_10_psi }}">
                        </div>

                        <div class="form-group col-md-3 telo5ce">
                            <label  for="intervalo_trabalho"><span><b>@lang('bocais.intervalo_trabalho')</b></span></label>
                            <input type="number" class="form-control telo5ce" min="0.0001" step="0.0001" id="intervalo_trabalho" name="intervalo_trabalho" maxlength="100" required value="{{ $bocal->intervalo_trabalho }}">
                        </div>
                        ...
                        <div class="form-group col-md-3 position telo5ce">
                            ...
                            <select name="tipo" id="tipo" class="form-control position  telo5ce" required>
                                <option value=""></option>
                                <option value="0" {{ ($bocal->tipo == "0") ? "selected": ""}}>Estático</option>
                                <option value="1" {{ ($bocal->tipo == "1") ? "selected": ""}}>Rotativo</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-3 position telo5ce">
                            ...
                            <select name="plug" id="plug" class="form-control position  telo5ce" required>
                                <option value=""></option>
                                <option value="0" {{ ($bocal->plug == "0") ? "selected": ""}}>Sim</option>
                                <option value="1" {{ ($bocal->plug == "1") ? "selected": ""}}>Não</option>
                            </select>
                        </div>
                    </div>
                </div>
           ...
           $(document).ready(function() {
               $("#formdados").validate({
                   ...
                   messages: {
                       ...
                       "nome": {
                           required: "Campo <strong>NÚMERO</strong> é obrigatório"
                       },
                       "vazao_10_psi": {
