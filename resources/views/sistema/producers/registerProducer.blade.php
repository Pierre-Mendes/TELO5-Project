                    ...
                    <div class="col-md-12 position">
                        <div class="form-row justify-content-left">
                            <div class="form-group col-md-6 telo5ce">
                                <label for="fabricante">Nome</label>
                                <input type="text" class="form-control telo5ce" name="fabricante" required>
                            </div>
                            <div class="form-group col-md-6 telo5ce">
                                <label for="modelo">Modelo</label>
                                <input type="text" class="form-control telo5ce" name="modelo" required>
                            </div>
                        </div>
                    </div>
                </div>
