    ...
    <div class="container-fluid topo">
        <div class="row align-items-start">
            ...
            <div class="col-6 text-right position">
                <a href="{{ route('producer.register') }}">
...
@section('conteudo')
        ...
        <div class="col-md-9 m-auto tabela">
                ...
                <tbody>
                    @foreach ($producers as $producer)
                        <tr>
                            ...
                            <td class="acoes">
                                <form action="{{ action('Sistema\ProducerController@destroy', $producer['id']) }}"
                                    method="POST" class="delete_form">
                                    {{ csrf_field() }}

                                    <a href="{{ route('producer.edit', $producer->id) }}"><button type="button"
                                            class=""><i class='fa fa-fw fa-pen'></i></button></a>
