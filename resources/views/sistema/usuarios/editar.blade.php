                    ...
                    <div class="col-md-12 position">
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-3 telo5ce">
                                ...
                                <input type="text" class="form-control telo5ce" id="nome" name="nome" maxlength="50" required value="{{ $usuarios->nome }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="rua">@lang('usuarios.rua')</label>
                                <input type="text" class="form-control telo5ce" id="rua" name="rua" maxlength="100" required value="{{ $usuarios->rua }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="cep">@lang('usuarios.cep')</label>
                                <input type="number" class="form-control telo5ce" id="cep" name="cep" maxlength="10" required value="{{ $usuarios->cep }}">
                            </div>
                            <div class="form-group col-md-3 position telo5ce">
                                <label for="cidade">@lang('usuarios.cidade')</label>
                                <input type="text" class="form-control position telo5ce" id="cidade" name="cidade" maxlength="60" required value="{{ $usuarios->cidade }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-3 telo5ce">
                                ...
                                <input type="number" class="form-control telo5ce" id="telefone" name="telefone" maxlength="15" required value="{{ $usuarios->telefone }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="estado">@lang('usuarios.estado')</label>
                                <input type="text" class="form-control telo5ce" id="estado" name="estado" maxlength="60" required value="{{ $usuarios->estado }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="pais">@lang('usuarios.pais')</label><br>
                                <input type="text" class="form-control telo5ce" id="pais" name="pais" maxlength="60" required value="{{ $usuarios->pais }}">
                            </div>
                            <div class="form-group col-md-3 position telo5ce">
                                <label for="tipo_usuario">@lang('usuarios.tipo_usuario')</label><br>
                                <select name="tipo_usuario" id="tipo_usuario" class="form-control position  telo5ce" require>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="form-group col-md-3 telo5ce">
                                ...
                                <input type="email" class="form-control telo5ce" id="email" name="email" maxlength="100" required value="{{ $usuarios->email }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="password">@lang('usuarios.senha')</label>
                                <input type="password" class="form-control telo5ce" id="password" name="password" maxlength="20" required value="{{ $usuarios->password }}">
                            </div>
                            <div class="form-group col-md-3 telo5ce">
                                <label for="confirmar_senha">@lang('usuarios.confirmar_senha')</label>
                                <input type="password" class="form-control telo5ce" id="confirmar_senha" name="confirmar_senha" maxlength="20" required value="{{ $usuarios->confirmar_senha }}">
                            </div>
                            <div class="form-group col-md-3 position telo5ce">
                            <label for="configuracao_idioma">@lang('usuarios.idioma')</label><br>
                                <select name="configuracao_idioma" id="configuracao_idioma" class="form-control position telo5ce" required>
