cadastrar_emissores@extends('_layouts._layout_site')
<?php
...
@section('topo_detalhe')
    <div class="container-fluid topo">
        <div class="row align-items-start">
            {{-- TITULO E SUBTITULO --}}
            <div class="col-6">
                <h1>@lang('afericao.cadastrar_emissores')</h1>
            </div>
        </div>
    </div>
@endsection
...
@section('conteudo')
    ...
    <form action="{{ route('spanAndIssuer_save') }}" method="POST" id="formdados" class="mx-5">
        ...
        <div class="row justify-content-center botaoAfericao mb-4" id="botoesSalvar">
            ...
            <button class="proximo ml-2" name="botao" value="proximo" type="" id="botaosalvar">@lang('unidadesAcoes.proximo')</button>
            <button class="proximo ml-2" type="" name="botao" value="sair" id="botaosalvar">@lang('unidadesAcoes.salvarSair')</button>
        </div>
    </form>
@endsection
