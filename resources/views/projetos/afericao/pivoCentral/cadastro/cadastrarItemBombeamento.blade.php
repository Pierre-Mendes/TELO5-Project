...
@section('topo_detalhe')
    <div class="container-fluid topo">
        <div class="row align-items-start">
            ...
            {{-- TITULO E SUBTITULO --}}
            <div class="col-6">
                <h1>@lang('afericao.cadastroItemBombeamento')</h1>
            </div>
...
@section('conteudo')
    ...
    <div class="formafericao">
            ...
            @for ($i = 1; $i <= $numero_bombas; $i++)
                <li class="nav-item">
                    <a class="nav-link {{ $i == 1 ? 'active' : '' }}" id="iGerais-tab" data-toggle="tab"
                        ...
                        aria-selected="true">@lang('afericao.bomba') {{ $i }}</a>
                </li>
            @endfor
        </ul>
        ...
        <form action="{{ route('pumping_item_save') }}" method="post" id="formdados">
            @csrf
                ...
                @for ($i = 1; $i <= $numero_bombas; $i++)
                    <div class="tab-pane fade {{ $i == 1 ? 'show active' : '' }}" id="bomba_{{ $i }}"
                        ...
                        <div class="col-md-12 formpivocentral" id="cssPreloader">
                            <div class="form-row justify-content-center">
                                <div class="col-md-3 form-group telo5ce">
                                    ...
                                    <input type="number" step="0.01" id="comprimento_succao_'+i+'" class="form-control"
                                        required name="comprimento_succao[]" onchange="validaCampo(this.value, this.id)">
                                </div>
                            ...
                            <div class="form-row justify-content-center">
                                <div class="col-md-3 form-group telo5ce">
                                    @component('_layouts._components._inputLabel', ['texto' => __('afericao.numeroRotores'),
                                    'id' => ''])@endcomponent
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    ...
                                    <input type="number" step="0.01" class="form-control" required name="diametro_rotor[]"
                                        id="diametro_rotor_'+i+'" onchange="validaCampo(this.value, this.id)">
                                </div>
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    ...
                                    <input type="number" step="0.01" class="form-control" required name="rendimento_bomba[]"
                                        id="rendimento_bomba_'+i+'" onchange="validaCampo(this.value, this.id)">
                                </div>
                            </div>
                            ...
                            <div class="form-row justify-content-start">
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    ...
                                    <input type="number" class="form-control" required name="rotacao[]" id="rotacao_'+i+'"
                                        onchange="validaCampo(this.value, this.id)">
                                </div>
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    ...
                                    __('unidadesAcoes.(mca)'), 'id' => ''])@endcomponent
                                    <input type="number" step="0.01" class="form-control" required name="pressao_bomba[]"
                                        id="pressao_bomba_'+i+'" onchange="validaCampo(this.value, this.id)">
                                </div>
                            </div>
                            ...
                            <div class="form-row justify-content-center">
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    @component('_layouts._components._inputLabel', ['texto' => __('afericao.numeroMotores'),
                                    'id' => ''])@endcomponent
                            ...
                            <div class="form-row justify-content-start">
                                <div class="col-md-3 form-group telo5ce">
                                    @component('_layouts._components._inputLabel', ['texto' => __('afericao.fatorServico'),
                                    'id' => ''])@endcomponent
                                ...
                                <div class="col-md-3 form-group telo5ce">
                                    @component('_layouts._components._inputLabel', ['texto' => __('afericao.rendimento'),
                                    'id' => ''])@endcomponent
                            ...
                            <div style="display:none;" class="motorEletrico" id="motorEletrico_{{ $i }}">
                                ...
                                <div class="form-row justify-content-start">
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_1_fase_1" name="corrente_leitura_1_fase_1[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('unidadesAcoes.(a)'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_1_fase_2" name="corrente_leitura_1_fase_2[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('unidadesAcoes.(a)'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_1_fase_3" name="corrente_leitura_1_fase_3[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                </div>
                                ...
                                <div class="form-row justify-content-start">
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        <input type="number" step="0.01" class="form-control has-value" value="0" readonly
                                            id="bomba_'+i+'_indice_carregamento_leitura_1_fase_1"
                                            onchange="validaCampo(this.value, this.id)">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('afericao.indice_carregamento'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control has-value" value="0" readonly
                                            id="bomba_'+i+'_indice_carregamento_leitura_1_fase_2"
                                            onchange="validaCampo(this.value, this.id)">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('afericao.indice_carregamento'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control has-value" value="0" readonly
                                            id="bomba_'+i+'_indice_carregamento_leitura_1_fase_3"
                                            onchange="validaCampo(this.value, this.id)">
                                    </div>
                                </div>
                                ...
                                <div class="form-row justify-content-start">
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('unidadesAcoes.(a)'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_2_fase_1" name="corrente_leitura_2_fase_1[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('unidadesAcoes.(a)'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_2_fase_2" name="corrente_leitura_2_fase_2[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('unidadesAcoes.(a)'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control"
                                            id="bomba_'+i+'_corrente_leitura_2_fase_3" name="corrente_leitura_2_fase_3[]"
                                            onchange="calcularCarregamento('+i+'); validaCampo(this.value, this.id);">
                                    </div>
                                </div>
                                ...
                                <div class="form-row justify-content-start">
                                    <div class="col-md-4 form-group telo5ce">
                                        @component('_layouts._components._inputLabel', ['texto' =>
                                        __('afericao.indice_carregamento'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control has-value" readonly value="0"
                                            id="bomba_'+i+'_indice_carregamento_leitura_2_fase_1">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('afericao.indice_carregamento'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control has-value" readonly value="0"
                                            id="bomba_'+i+'_indice_carregamento_leitura_2_fase_2">
                                    </div>
                                    ...
                                    <div class="col-md-4 form-group telo5ce">
                                        ...
                                        __('afericao.indice_carregamento'), 'id' => ''])@endcomponent
                                        <input type="number" step="0.01" class="form-control has-value" readonly value="0"
                                            id="bomba_'+i+'_indice_carregamento_leitura_2_fase_3">
                                    </div>
                                </div>
                            </div>
                        </div>
