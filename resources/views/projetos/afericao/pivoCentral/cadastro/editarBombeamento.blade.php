    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="iGerais-tab" data-toggle="tab" href="#iGerais" role="tab"
                aria-controls="iGerais" aria-selected="true">Editar bombeamento</a>
        </li>
    </ul>
    <form action="{{route('editaBombeamento')}}" method="POST" id="formdados">
        @csrf
        ...
        <div class="text-center botaoAfericao">
            <a class="voltar ml-3" href="{{route('editarItemBombeamento', $cabecalho_bombeamento['id'])}}" name="botao" style="padding: 10px; width: 250px;">@lang('Editar Item Bombeamento')</a>
        </div>
    </form>
@endsection
