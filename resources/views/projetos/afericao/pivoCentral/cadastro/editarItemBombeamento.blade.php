...
@section('topo_detalhe')
    <div class="container-fluid topo">
        <div class="row align-items-start">
            {{-- TITULO E SUBTITULO --}}
            <div class="col-6">
                <h1>@lang('afericao.editarItemBombeamento')</h1>
            </div>
...
<div class="formafericao">
    ...
    <form action="{{route('pumping_item_update')}}" method="POST" id="formdados">
        @csrf
        ...
        {{-- <div class="text-center">
            ...
            <button  class="proximo"><a id="" href="{{route('gauging_status', $id_afericao)}}" style="color: #fff;"> @lang('unidadesAcoes.voltar')</a></button>
        </div> --}}
    </form>
</div>
@endsection
