...
@section('topo_detalhe')
    ...
    <div class="container-fluid topo">
        <div class="row align-items-start">
            {{-- TITULO E SUBTITULO --}}
            <div class="col-6">
                <h1>@lang('afericao.cadastrar_velocidadeAfericao')</h1>
            </div>
...
@section('conteudo')
    <div class="formafericao">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" id="afericoes-tab" data-toggle="tab" href="#afericoes" role="tab"
                    aria-controls="afericoes" aria-selected="true">@lang('comum.informacoes_navtabs')</a>
            </li>
        </ul>
        ...
        <form action="{{ route('gauging_speed_save', $id_afericao) }}" id="form_submit" method="POST">
            @csrf
