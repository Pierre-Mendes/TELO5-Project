                ...
                <div id="collapseBombeamento" class="collapse show" aria-labelledby="headingBombeamento" data-parent="#accordion">
                    <div class="card-body row">
                        ...
                        <div class="col-md-3 form-group telo5ce">
                            ...
                            <input id="numero_bombas" type="number" class="form-control" min="1" required name="numero_bombas">
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div id="DivBombas"></div>
    </form>
</div>
@endsection
...
html = '<div class="card-body " id="bomba_'+i+'">';
                ...
                if (i == 1){
                html += '   <div class="col-md-12 collapse show" id="control_bomba_'+i+'" aria-labelledby="headingBomba_'+i+'" data-parent="#DivBombas">';
                }
                ...
                html += '              <label for=""><span style="font-size: 16px"><b>@lang("afericao.motor") '+i+'</b></span> </label>';
                html += '           </div>';
                html += '           <div class="col-md-4 form-group telo5ce">';
                ...
                html += '       <div class="form-row justify-content-center">';
                html += '           <div class="col-md-12 telo5ce" id="div_leituras_'+i+'">';
                html += '              <label for=""><span style="font-size: 16px"><b>@lang("afericao.motor") '+i+'</b></span> </label>';
                html += '           </div>';
