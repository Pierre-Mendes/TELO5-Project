...
@section('titulo')
@lang('afericao.editarAdutora')
@endsection

@section('conteudo')

<div class="">
    <form action="{{route('editaMotorBomba')}}" method="POST">
        @csrf
    <input type="hidden" value="{{$id_afericao}}" name="id_afericao">
    <h3 class="mb-0">@lang('afericao.trechos')</div>
        <div id="collapseAdutora" aria-labelledby="headingAdutora">
            <div class="container">
                            ...
                            <tr>
                                ...
                                <td style="width: 150px">
                                    <select class='form-control' name="tipo_cano[]">
                                        ...
                                        <option  @if($dado['tipo_cano'] == 0) selected @endif value="0"> @lang('afericao.acoSac')</option>
                                        <option  @if($dado['tipo_cano'] == 1) selected @endif value="1">@lang('afericao.az')</option>
                                        <option  @if($dado['tipo_cano'] == 2) selected @endif value="2">@lang('afericao.ferroFundido')</option>
                                ...
                                <td><input type="number" step="0.001" name="diametro[]" value="{{$dado['diametro']}}" required class="form-control"></td>
                                <td><input type="number" name="coeficiente_hw[]" value="{{$dado['coeficiente_hw']}}" required class="form-control"></td>
                                <td><input type="number" name="numero_canos[]" value="{{$dado['numero_canos']}}" required class="form-control"></td>
                                <td><input type="number" name="comprimento[]" value="{{$dado['comprimento']}}" required class="form-control"></td>
                                <td><input type="number" step="0.01" name="desnivel[]" value="{{$dado['desnivel']}}" required class="form-control"></td>
                                <td hidden><input type="number" name="altitude_trecho[]" value="0"  class="form-control"></td>
                                <td hidden><input type="number" name="latitude_trecho[]" value="0"  class="form-control"></td>
                                <td hidden><input type="number" name="longitude_trecho[]" value="0"  class="form-control"></td>
                                <td><button class="btn btn-outline-danger" onclick="deletarLinha(this)" type="button"><i class="fa fa-fw fa-trash"></i></button></td>
                            </tr>
                        @endforeach
                        @endif
                    </tbody>
        ...
        <div class="text-center">
            ...
            <button type="submit" value="sair" name="botao_form" id="btnSalvarAdutora" class="btn btn-outline-primary"> @lang('unidadesAcoes.salvarSair')</button>            
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            <form id="formTrecho" action="" class="row" >
                ...
                <div class="form-group col-md-6">
                    <input type="number" class="form-control" required name="comprimento" id="comprimento">
                ...
                <div class="form-group col-md-6">
                    ...
                    @component('_layouts._components._inputLabel', ['texto'=>__('afericao.desnivel'), 'id' => 'desnivel'])@endcomponent                                                                                                
                </div>
