            ...
            <div class="do-not-break">
                ...
                @foreach ($trechos_adutora as $key => $trecho)
                    <div class="row">
                        ...
                        <div class="col-md-2 text-center">
                            @if ($trecho['tipo_cano'] == 0) @lang('afericao.acoSac')
                            @endif
                            @if ($trecho['tipo_cano'] == 1) @lang('afericao.az')
                            @endif
                            @if ($trecho['tipo_cano'] == 2) @lang('afericao.ferroFundido')
                            @endif
                            ...
                            @if ($trecho['tipo_cano'] == 9) @lang('afericao.aluminio')
                            @endif
                        </div>
                        <div class="col-md-2 text-center">
