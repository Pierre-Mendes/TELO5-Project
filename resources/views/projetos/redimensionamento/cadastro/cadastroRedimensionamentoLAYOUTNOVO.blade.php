...
<form action="{{route('atualizaRedimensionamento')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="tab-content small.required tab-validate mt-5" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="primeiraEtapa" role="tabpanel" aria-labelledby="primeiraEtapa-tab">
            <div class="col-md-12 formpivocentral pb-5" id="cssPreloader">
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.pressaoBomba')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.giroEquipamento')@lang('unidadesAcoes.(graus)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.coeficienteRugosidadeA')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.valvula')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.emissores')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.alcanceCanhao')@lang('unidadesAcoes.(m)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.coeficienteRugosidadeP')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.laminaAnual')@lang('unidadesAcoes.(mm/ha/ano)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.custoMedio')@lang('unidadesAcoes.($/kWh)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.defletor')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.valvReg')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                           <label for="">@lang('redimensionamento.vazaoCanhao')@lang('unidadesAcoes.(m3/h)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                            <label for="">@lang('redimensionamento.utilizarPlug')</label> 
                        ...
                        <div class='form-group col-md-3 telo5ce'>
                            <label for="">@lang('redimensionamento.utilizarPressaoCentro')</label> 
                            <select disabled name="utilizar_pressao_centro" id="utilizar_pressao_centro" class="form-control">
                                <option value="sim">@lang('fichaTecnica.sim')</option>
                                <option value="nao">@lang('fichaTecnica.nao')</option>
                            </select>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                            <label for="">@lang('redimensionamento.utilizarPlugAteTorre')</label> 
                            <input class="text-center col form-control" name="lances_c_plug" type="number" value="{{$redimensionamento[0]->lances_c_plug}}">
                            @component('_layouts._components._inputLabel', ['texto'=>'' , 'id' => ''])@endcomponent
                        </div>
                        <div class='form-group col-md-3 telo5ce'>
                            <label for="">@lang('redimensionamento.espacamentoMaximoPlug')</label> 
            ...
            <div class="col-md-12 formpivocentral pb-5">
                ...
                <div>
                    ...
                    <div class="form-row justify-content-start">
                        ...
                        <div class='form-group col-md-3 telo5ce'>
                            <input class="text-center col form-control mb-5" disabled  type="text" value="{{ number_format($afericao[0]->pressao_ponta_requerida, 2, ',', '.')}}">
                            @component('_layouts._components._inputLabel', ['texto'=>'' , 'id' => ''])@endcomponent
                        </div>
                    </div>
                </div>
