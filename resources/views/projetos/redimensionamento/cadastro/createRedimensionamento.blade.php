                    ...
                    <div>
                        <div class="form-row justify-content-start">
                            <div class="form-group col-md-4 telo5ce">
                                ...
                                <input type="file" accept=".jpg" id="imagens_curvas_bomba" multiple name="images[]" class="proximo">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row col-12">
                        {{-- <div class="col-12  text-light text-center" style="padding-top: 1%">
                            <a class="btn btn-outline-success"
                                href="{{ route('status_redimensionamento', $redimensionamento[0]['id_afericao']) }}">
