    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="primeiraEtapa-tab" data-toggle="tab" href="#primeiraEtapa" role="tab"
                aria-controls="primeiraEtapa" aria-selected="true">1ª @lang('redimensionamento.etapa')</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="segundaEtapa-tab" data-toggle="tab" href="#segundaEtapa" role="tab"
                aria-controls="segundaEtapa" aria-selected="false">2ª @lang('redimensionamento.etapa')</a>
        <li class="nav-item">
            <a class="nav-link" id="imagem-tab" data-toggle="tab" href="#imagem" role="tab" aria-controls="imagem"
                aria-selected="false">3ª @lang('redimensionamento.etapa')</a>
        </li>
    </ul>
    ...
    <div class="tab-content small.required tab-validate mt-5" id="myTabContent">
        ...
        <div class="tab-pane fade show active" id="primeiraEtapa" role="tabpanel" aria-labelledby="primeiraEtapa-tab">
            <div class="col-12 m-auto tabela " id="cssPreloader">
                <table class="table table-striped mx-auto mt-5 text-center mb-5" id="tabelaTrechos">
                    <thead>
                        <tr>
                            <th></th>
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->somatorio_vazao_ok, 2, ',', '.')}}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->pressao_na_bomba, 2, ',', '.')}}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->angulo_pivo, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td>@lang('redimensionamento.coeficienteRugosidadeA')</td>
                                <td><input type="number" name="rugosidade_adutora" class="text-center col form-control" value="{{ number_format($redimensionamento[0]->rugosidade_adutora, 2)}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->rugosidade_adutora, 2, ',', '.')}}"></td>
                            </tr>
                            ...
                            <tr>
                                <td>@lang('redimensionamento.emissores')</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->alcance_canhao_final, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td>@lang('redimensionamento.coeficienteRugosidadeP')</td>
                                <td><input type="number" name="rugosidade_pivo" class="text-center col form-control" value="{{ number_format($redimensionamento[0]->coeficiente_rugosidade, 2)}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->coeficiente_rugosidade, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td>@lang('redimensionamento.laminaAnual')@lang('unidadesAcoes.(mm/ha/ano)')</td>
                                <td><input type="number" step="0.01" name="lamina_anual" class="text-center col form-control" value="{{ number_format($redimensionamento[0]->lamina_anual, 2)}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->lamina_anual, 2, ',', '.')}}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->custo_medio, 2, ',', '.')}}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ $afericao[0]->defletor}}"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->vazao_canhao_final, 2, ',', '.')}}"></td>
                            </tr>
        ...
        {{-- 2º ETAPA --}}
        <div class="tab-pane fade" id="segundaEtapa" role="tabpanel" aria-labelledby="segundaEtapa-tab">
            {{-- <div class="col-md-12 formpivocentral pb-5">
                <div class="form-row justify-content-start">
                    <div class="col-3 text-center">@lang('redimensionamento.redim')</div>
                    <div class="col-3 text-center">@lang('redimensionamento.afericao')</div>
                </div>
                
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.pressaoRequerida') 5.4.2 @lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                        <label for="">@lang('redimensionamento.hfAdutora')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                        <label for="">@lang('redimensionamento.desnivelMotobomba')@lang('unidadesAcoes.(m)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                        <label for="">@lang('redimensionamento.pressaoCentro')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                        <label for="">@lang('redimensionamento.hfParteAerea')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.desnivelMaisAlto')@lang('unidadesAcoes.(m)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.areaTotal')@lang('unidadesAcoes.(ha)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.velocidade100')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.areaSemCanhao')@lang('unidadesAcoes.(ha)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.lamina')@lang('unidadesAcoes.(mm)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.tempoFuncionamento')@lang('unidadesAcoes.(h)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.pressaoRequerida')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.pressaoPontaCalculada')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-4 telo5ce'>
                            <label for="">@lang('redimensionamento.pressaoPontaRequerida')@lang('unidadesAcoes.(mca)')</label> 
                        </div>
                    </div>
                    <div class="form-row justify-content-start">
                        <div class='form-group col-md-3 telo5ce'>
                ...
                <table class="table table-striped mx-auto mt-5 text-center mb-5" id="tabelaTrechos">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->pressao_5_4_2, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($redimensionamento[0]->pressao_5_4_2, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.hfAdutora')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->hf_adutora, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->hf_adutora, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.desnivelMotobomba')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input  readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->desnivel_motobomba, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->desnivel_motobomba, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.pressaoCentro')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->pressao_centro, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->pressao_centro, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.hfParteAerea')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->somatorio_perda_carga_real * 1.1, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->somatorio_perda_carga_real * 1.1, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.desnivelMaisAlto')@lang('unidadesAcoes.(m)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->desnivel_total, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->desnivel_total, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.areaTotal')@lang('unidadesAcoes.(ha)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->area_total_com_canhao, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->area_total_com_canhao, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.velocidade100')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->tempo_a_100, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->tempo_a_100, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.areaSemCanhao')@lang('unidadesAcoes.(ha)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->area_total, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->area_total, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.lamina')@lang('unidadesAcoes.(mm)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->lamina, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->lamina, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.tempoFuncionamento')@lang('unidadesAcoes.(h)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->tempo, 0, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->tempo, 0, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.pressaoRequerida')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->pressao_requerida, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($redimensionamento[0]->pressao_requerida, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.pressaoPontaCalculada')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->pressao_ponta, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->pressao_ponta, 2, ',', '.')}}"></td>
                            </tr>

                            <tr>
                                <td><label for="">@lang('redimensionamento.pressaoPontaRequerida')@lang('unidadesAcoes.(mca)')</label></td>
                                <td><input readonly class="text-center col form-control" type="text" value="{{ number_format($redimensionamento[0]->pressao_ponta_requerida, 2, ',', '.')}}"></td>
                                <td><input class="text-center col form-control" disabled  type="text" value="{{ number_format($afericao[0]->pressao_ponta_requerida, 2, ',', '.')}}"></td>
                            </tr>
            ...
            <div class="col-md-12">
                ...
                {{-- <div>
                    <div class="form-row justify-content-center">
                        <a class="btn btn-outline-success" href="{{route('resizing_status', $redimensionamento[0]['id_afericao'] )}}" > <i class="fa fa-check fa-fw"></i> @lang('unidadesAcoes.sair')</a>
                    </div>
                </div> --}}
            </div>
        </div>
