...
class LevantamentoAdutoraController extends Controller
{
    ...
    public function editaBombeamento(Request $req)
    {
        ...
        $id_bombeamento = $cabecalho['id'];
        $numero_bombas = $cabecalho["numero_bombas"];
        // return view('projetos.afericao.pivoCentral.cadastro.editarItemBombeamento', compact('numero_bombas', 'id_bombeamento'));
        return redirect()->route('editarItemBombeamento', ['id_bombeamento' => $id_bombeamento, 'id_afericao' => $id_afericao]);
    }
    ...
    public function editarItemBombeamento($id_bombeamento)
    {
