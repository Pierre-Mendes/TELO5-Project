...
Route::group(['middleware' => 'auth', 'middleware' => 'verified'], function () {
    ...
    Route::group(['middleware' => 'administrador'], function () {
        ...
        */
        ...
        Route::get('/fabricantes/cadastrar', ['as' => 'fabricantes.cadastrar', 'uses' => 'Sistema\BocalController@cadastraFabricante']);
        Route::post('/fabricantes/salva', ['as' => 'fabricantes.salva', 'uses' => 'Sistema\BocalController@cadastraFabricante']);
        ...
        // LISTAGEM DO FABRICANTE NA TABELA DE BOCAIS - (ESSA ROTA SÓ É USADA PARA APRESENTAÇÃO NA VIEW DA PÁGINA DE)
        Route::get('/fabricantes', ['as' => 'fabricantes.gerenciar', 'uses' => 'Sistema\BocalController@getListaDeFabricantes']);
        ...
        Route::post('/bocais/edita', ['as' => 'bocais.edita', 'uses' => 'Sistema\BocalController@editaBocal']);
        Route::delete('/bocais/remove/{id}', ['as' => 'bocais.remove', 'uses' => 'Sistema\BocalController@destroy']);
        Route::get('/bocais/bocal/{id}', ['as' => 'bocais.bocal', 'uses' => 'Sistema\BocalController@getInfosBocal']);

        //FABRICANTES DE BOCAL - ROTAS ( PRODUCER = FABRICANTE DE BOCAIS)
        ...
        Route::post('/producer/edita', ['as' => 'producer.edita', 'uses' => 'Sistema\ProducerController@editaProducer']);
    ...
    Route::group(['middleware' => 'assistente'], function () {
        ...
        Route::post("/afericao/pivo_central/mapa_original/editar", ['as' => 'mapa_original_editar', 'uses' => 'Projetos\Afericao\PivoCentral\MapaOriginalController@editarMapaOriginal']);
        ...
        Route::post('/afericao/pivo_central/bombeamento/salvarItemBombeamento', ['as' => 'salvarItemBombeamento.salvar', 'uses' => 'Projetos\Afericao\PivoCentral\LevantamentoAdutoraController@salvarItemBombeamento']);
        Route::post("/afericao/pivo_central/bombeamento/editaItemBombeamento", ['as' => 'editaItemBombeamento', 'uses' => 'Projetos\Afericao\PivoCentral\LevantamentoAdutoraController@editaItemBombeamento']);
        Route::get("/afericao/pivo_central/bombeamento/editarItemBombeamento/{id}", ['as' => 'editarItemBombeamento', 'uses' => 'Projetos\Afericao\PivoCentral\LevantamentoAdutoraController@editarItemBombeamento']);
