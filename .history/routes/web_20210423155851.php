...
//*****************************************************************************************************************************************//
        ...
        */
        ...
        Route::get('/tiposBocais', ['as', => 'tiposbocais.list', 'uses' => 'Sistema\BocalController@getlistTposBocais']);
        Route::get('/tiposBocais', ['as'=>'tiposbocais.gerenciar', 'uses'=>'Sistema\BocalController@getListaDeBocais']);
//*****************************************************************************************************************************************//
