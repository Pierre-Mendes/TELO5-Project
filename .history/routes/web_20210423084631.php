...
//*****************************************************************************************************************************************//
        ...
        */
        ...
        Route::get('/producer/register', ['as' => 'producer.register', 'uses' => 'Sistema\FabricanteController@registerProducer']);
        Route::get('/producer/edit/{id}', ['as' => 'producer.edit', 'uses' => 'Sistema\ProducerController@getListaDeBocais']);
//*****************************************************************************************************************************************//
