...
//*****************************************************************************************************************************************//
        ...
        */
        ...
        Route::get('/producer/register', ['as' => 'producer.register', 'uses' => 'Sistema\FabricanteController@registerFabricante']);
        Route::get('/producer/edit/{id}', ['as', => 'producer.edit', => 'uses' => 'Sistema\FabricanteController@editProducer'])
//*****************************************************************************************************************************************//
