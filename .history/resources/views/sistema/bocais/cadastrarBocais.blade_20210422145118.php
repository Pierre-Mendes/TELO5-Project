        ...
        (function($) {
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    cols += '<td><button type="button" class="removetablerow" onclick="remove(this)" style="outline: none; cursor: pointer; margin-top: 4px; justify-content"><i class="fa fa-fw fa-times fa-lg"></i></button></td>';
