            ...
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    var  = "";
                     ...
                     += '<td><input type="number" min=1 step=0.0001 class="form-control" required name="numero[]" id="numero"></td>';
                     += '<td><input type="number" class="form-control" required name="vazao_10_psi[]" id="vazao10psi"></td>';
                     += '<td><input type="number" min=0.001 step="0.0001" class="form-control" required name="intervalo_trabalho[]" id="intervalotrabalho"></td>';
                     += '<td><select class="form-control"><option value=""></option><option value="0">@lang('bocais.nao')</option><option value="1">Sim</option></select></td>'
