...
@section('scripts')
    <script type="text/javascript">
        ...
        col += '<td><input type="number" required name="tipo_cano[]" value="'+ formulario["tipo_cano"] +'" readonly class="form-control"></td>';
        col += '<td style="width: 150px">' + criarSelectTipoCano(formulario['tipo_cano']).prop('outerHTML') + '</td>';
        col += '<td><input type="number" required name="diametro[]" value="'+ formulario["diametro"] +'" class="form-control"></td>';
        col += '<td><input type="number" required  name="coeficiente_hw[]" value="'+ formulario["coeficiente_hw"] +'" class="form-control"></td>';
        col += '<td><input type="number" required  name="numero_canos[]" value="'+ formulario["numero_canos"] +'" class="form-control"></td>';
        col += '<td><input type="number" required  name="comprimento[]" value="'+ formulario["comprimento"] +'" class="form-control"></td>';
        col += '<td><input type="number" required  name="desnivel[]" value="'+ formulario["desnivel"] +'" class="form-control"></td>';
        col += '<td hidden><input type="number"  name="altitude_trecho[]" value="0" class="form-control"></td>';
        col += '<td hidden><input type="number"  name="latitude_trecho[]" value="0" class="form-control"></td>';
        col += '<td hidden><input type="number"  name="longitude_trecho[]" value="0" class="form-control"></td>';
        col += '<td>';
        col += '<button class="btn btn-outline-danger" onclick="deletarLinha(this)" type="button"><i class="fa fa-fw fa-trash"></i></button>';
        col += '</td>';
        newRow.append(cols);
