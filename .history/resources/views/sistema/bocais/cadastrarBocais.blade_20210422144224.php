...
@section('scripts')
    ...
    <script>
        ...
        <script>
                AddTableRow = function() {
                    ...
                    cols +=
                        '<td><input type="number" min=0.001 step=0.001 class="form-control" required name="diametro[]" id="diametro"></td>';
                    cols +=
                        '<td><input type="number" class="form-control" required name="coeficiente_hw[]" id="coeficiente_hw"></td>';
                    cols +=
                        '<td><input type="number" min=1 class="form-control" required name="numero_canos[]" id="numero_canos"></td>';
                    cols +=
    ...
    @includ('_layouts._includes._validators_jquery')
@endsection
