        ...
        (function($) {
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    cols += '<td><input type="number" min=1 step=0.001 class="form-control telo5ce" required name="numero[]" id="numero"></td>';
                    cols += '<td><input type="number" class="form-control telo5ce" required name="vazao_10_psi[]" id="vazao10psi"></td>';
