                ...
                <form action="{{ route('bocais.cadastra') }}" method="POST" id="formdados">
                    ...
                    <table class="table table-striped mx-auto" id="tabelaTrechos">
                        ...
                        <tbody>
                            ...
                            <td><input type="number" min=0.1 step=0.1 class="form-control" required name="nome[]" id="nome">
                            </td>
                            <td><input type="number" min=0.0001 step=0.1 class="form-control" required name="vazao_10_psi[]"
                                    id="vazao10psi"></td>
