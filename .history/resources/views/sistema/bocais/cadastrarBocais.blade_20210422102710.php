                ...
                <form action="{{route('bocais.cadastra')}}" method="POST">
                    ...
                    <div class="table table-striped mx-auto" id="filtertable">
                        ...
                        <table class="table table-striped mx-auto" id="filtertable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="number" step="1" min="1" name="fabricante" id="fabricante" class="form-control" req></td>
                                    <td><input type="number" step="0.01" min="0.01" name="vazaoPSI" id="fabricante" class="form-control"></td>
                                    <td><input type="number" step="0.01" min="0.01" name="intervaloTrabalho" id="fabricante" class="form-control"></td>
                                    <td></td>
                                </tr>
                            </tbody>
