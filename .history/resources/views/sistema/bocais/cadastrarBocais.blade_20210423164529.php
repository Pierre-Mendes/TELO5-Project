...
@section('scripts')
        ...
        (function($) {
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    select += '<td><input type="number" min=1 step=0.0001 class="form-control" required name="numero[]" id="numero"></td>';
                    select += '<td><input type="number" class="form-control" required name="vazao_10_psi[]" id="vazao10psi"></td>';
                    select += '<td><input type="number" min=0.001 step="0.0001" class="form-control" required name="intervalo_trabalho[]" id="intervalotrabalho"></td>';
                    select += '<td><select class="form-control"><option value=""></option><option value="0">@lang('bocais.nao')</option><option value="1">Sim</option></select></td>'
                    select += '<td><div class="row justify-content-center"><button type="button" class="removetablerow" onclick="remove(this)" style="outline: none; cursor: pointer; margin-top: 4px; justify-content: center;"><i class="fa fa-fw fa-times fa-lg"></i></button></div></td>';
    ...
    var select = $("<select class='form-control' name=\"fabricante[]\" />");
    var optionsValues = [];
    var optionsTexts = [];
