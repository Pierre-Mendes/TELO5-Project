            ...
            <div class="tab-pane fade show active" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
                <form action="{{route('bocais.cadastra')}}" method="POST">
                    ...
                    <div class="table table-striped mx-auto" id="filtertable">
                        <div class="row mt-3 telo5ce">
                            <div class="col-md-3">
                                <label for="fabricante">@lang('bocais.fabricante')</label>
                                <input class="form" type="text" name="fabricante" id="fabricante" class="form-control" required/>
                            </div>
                            ...
                            <div class="col-md-2">
                               ...
                               <div id="alvo">
                                <select name="options" class="col-md-11 has-value">
                                    <option value=""></option>
