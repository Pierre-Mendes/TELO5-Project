        ...
        (function($) {
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    cols += '<td><div class="ml-"><button type="button" class="removetablerow" onclick="remove(this)" style="outline: none; cursor: pointer; margin-top: 4px; justify-content: center;"><i class="fa fa-fw fa-times fa-lg"></i></button></div></td>';
