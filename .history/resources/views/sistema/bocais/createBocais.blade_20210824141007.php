                ...
                <div class="tab-pane fade show active" id="cadastro" role="tabpanel" aria-labelledby="cadastro-tab">
                    ...
                    <div id="cssPreloader">
                            <div class="form-row justify-content ml-4 mt-4 telo5ce">
                                <div class="form-group col-md telo5ce">
                                    <label for="marca">@lang('bocais.marca')</label>
                                    <input type="text" class="form-control telo5ce" id="marca" name="marca" maxlength="50" required autocomplete="off" style="text-transform: capitalize">
                                </div>

                                <div class="col-md-2">
                                    <label for="modelo">@lang('bocais.modelo')</label>
                                    <input type="text" class="form-control telo5ce" id="modelo" name="modelo" maxlength="50" required autocomplete="off" style="text-transform: capitalize">
                                </div>

                                <div class="col-md-2">
                                    <label for="pressao_psi">@lang('bocais.pressao')</label>
                                    <select class="form-control" name="pressao_psi" id="pressao_psi">
                                        <option value=""></option>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="col-md-2" style="width: 40%;">
                                            ...
                                            name="nome[]" id="nome" autocomplete="off">
                                        </td>
