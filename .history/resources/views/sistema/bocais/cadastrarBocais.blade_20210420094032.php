    ...
    <div class="container-fluid topo">
        <div class="row align-items-start">
            ...
            <div class="col-6 text-right botoes position">
                <a href="{{ route('faab.gerenciar') }}" style="color: #3c8dbc">
                    <button type="button">
                ...
                <form action="{{route('bocais.cadastra')}}" method="POST">
                    ...
                    <div class="table table-striped mx-auto" id="filtertable">
                        ...
                        <table class="table table-striped mx-auto" id="filtertable">
                            ...
                            <tbody>
                                <tr>
                                    <td><input type="text" name="fabricante" id="fabricante" class="form-control" />
                                    <td><input type="number" name="vazaoPSI" id="fabricante" class="form-control" />
                                    <td><input type="number" name="intervaloTrabalho" id="fabricante" class="form-control"></td>
                                    <td></td>
                                </tr>
                            </tbody>
