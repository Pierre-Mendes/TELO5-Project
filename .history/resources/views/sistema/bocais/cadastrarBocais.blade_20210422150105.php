        ...
        (function($) {
            //function add line/row Table
                AddTableRow = function() {
                    ...
                    cols += '<td><input type="number" min=1 step=0.001 class="form-control" required name="numero[]" id="numero"></td>';
                    cols += '<td><input type="number" class="form-control" required name="vazao_10_psi[]" id="vazao10psi"></td>';
                    cols += '<td><input type="number" min=0.001 step="0.001" class="form-control" required name="intervalo_trabalho[]" id="intervalotrabalho"></td>';
                    cols += '<td><div class="form-row justify-content-start"><button type="button" class="removetablerow" onclick="remove(this)" style="outline: none; cursor: pointer; margin-top: 4px; justify-content: center;"><i class="fa fa-fw fa-times fa-lg"></i></button></div></td>';
