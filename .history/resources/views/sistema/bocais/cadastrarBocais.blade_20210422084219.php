                        ...
                        <table class="table table-striped mx-auto" id="filtertable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" step="0." name="vazaoPSI" id="fabricante" class="form-control" />
                                    <td><input type="number" step="0." name="intervaloTrabalho" id="fabricante" class="form-control"></td>
                                    <td></td>
                                </tr>
                            </tbody>
