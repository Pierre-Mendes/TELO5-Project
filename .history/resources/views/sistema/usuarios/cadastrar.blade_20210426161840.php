                ...
                <div class="col-md-12 position">
                    ...
                    <div class="form-row justify-content-center">
                        ...
                        <div class="form-group col-md-3 telo5ce">
                            ...
                            <select required name="configuracao_idioma" id="configuracao_idioma" class="form-control telo5ce">
    ...
    <script>
        $("#formdados").validate({
            ...
            messages: {
                ...
                tipo_usuario: "Tipo_usuario Obrigatório!",
                email: "Email Obrigatório!",
                password: "Password Obrigatório!",
                confirmar_senha: "Confirmar_senha Obrigatório!"
            },
