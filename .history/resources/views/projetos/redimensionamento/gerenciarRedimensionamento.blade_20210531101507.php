...
@section('topo_detalhe')
    ...
    <div class="container-fluid topo">
        <div class="row align-items-start">
            ...
            {{-- Log/Create Button --}}
            <div class="col-6 text-right position botoes">
                {{-- <a href="{{ route('resizing_create') }}"><span></span></a> --}}
                <button type="button" data-toggle="modal" data-target="#novoRedimensionamento"><i
        ...
        <div class="row justify-content-end telo5inputfiltro mt-3">
            <div class="col-3 position">
                <input class="form-control" id="filtrotabela" type="text" placeholder="@lang('comum.pesquisar')"><i
        ...
        <table class="table table-striped mx-auto" id="filtertable">
            ...
            <thead class="headertable">
                <tr class="text-center">
                    <th scope="col-md-5">@lang('afericao.nomePivo')</th>
                    <th scope="col-md-5">@lang('redimensionamento.dataRedim')</th>
                    <th scope="col-md-5">@lang("afericao.pivo")</th>
                    <th scope="col-md-5">@lang("afericao.numeroLances")</th>
                    <th scope="col-md-5">@lang('sidenav.acoes')</th>
                </tr>
            </thead>
            ...
            <tbody>
                @foreach ($redimensionamentos as $redimensionamento)
                    <tr>
                        ...
                        <td>{{ $redimensionamento->marca_modelo_pivo }}</td>
