            ...
            <section>
                ...
                <div id="main">
                    <ul id="menu" class="nav navbar-right header-usuario">
                        ...
                        <li id="user"><img src="{{ asset('img/ico_user.png') }}" alt="" class="icones"><span>Lucas
                                Steinbach</span><i class="fas fa-caret-down "></i>
                            <ul>
                                ...
                                <li><a href="{{ route('proprietarios.gerenciar') }}">@lang('sidenav.proprietarios')</a>
                                </li>
