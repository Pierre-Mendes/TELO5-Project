...
class ProducerController extends Controller
{
    ...
    {
        $dados = $req->all();
        $check = FabricanteBocal::where('fabricante', $dados['fabricante'])->where('fabricante', $dados['fabricante'])->count();
        ...
        {
            Notificacao::gerarAlert('Fabricantes.aviso', 'Fabricante.assistente_ja_cadastrado_fazenda', 'warning');
        }
    }
}
