...
{
    public function getListaDeFabricantes(Request $req){
        $fabricantes = FabricanteBocal::select('id', 'fabricante', 'modelo')->paginate(30);

        return view('sistema.pivos.gerenciarFabricantesBocais', compact('fabricantes'));
    }
    ...
    public function cadastrarBocal(){
        return view('sistema.pivos.cadastrarBocais');
    }
    ...
    public function getListaDeBocais(Request $req){
        ...
        return view('sistema.pivos.gerenciarBocais', compact('bocais', 'filtro', 'fabricantes'));
    }
